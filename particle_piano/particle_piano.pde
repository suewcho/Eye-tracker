...
void draw() {
  ...
  ps.run();
  if (r1<width/7){
    file = new SoundFile(this, "C4.mp3");
    //file.playFor(file.duration());
  }else if (r1<width*2/7){
    file = new SoundFile(this, "D4.mp3");
    //file.play();
  }else if (r1<width*3/7){
    file = new SoundFile(this, "E4.mp3");
    //file.play();
  }
  else if (r1<width*4/7){
    file = new SoundFile(this, "F4.mp3");
    //file.play();
  }else if (r1<width*5/7){
    file = new SoundFile(this, "G4.mp3");
    //file.play();
  }else if (r1<width*6/7){
    file = new SoundFile(this, "A4.mp3");
    //file.play();
  }else if (r1<width){
    file = new SoundFile(this, "B4.mp3");
    //file.play();
  }
  file.play();
  delay(30);
